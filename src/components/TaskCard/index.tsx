...
const TaskCard = (props: TaskCardProps) => {
  const { task, options, className } = props;
  const TaskCardClassName = className || '';
  return (
    <div
      className={`flex items-center text-white gap-4 px-2 bg-stone-700 rounded py-1 ${TaskCardClassName}`}
    >
